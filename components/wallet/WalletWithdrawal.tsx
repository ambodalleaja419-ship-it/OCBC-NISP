           ...
           <div className="lg:col-span-1">
               <div className="bg-darkblue2 border border-borderGray rounded-lg p-0 overflow-hidden">
                   ...
                   <form onSubmit={handleSubmit} className="p-4 space-y-4">
                       ...
                       <div className="pt-2">
                           <button type="submit" disabled={isLoadingTransactions} className="bg-primary hover:bg-red-600 text-white font-medium py-2 px-4 rounded text-sm transition-colors">
                                ...
                                <tbody>
                                    {withdrawalHistory.map(wd => (
                                        <tr key={wd.id} className="border-b border-gray-700 text-xs">
                                            <td className="p-3 text-gray-400 border-r border-gray-700 font-sans tabular-nums">$ 0</td>
                                            <td className="p-3 text-gray-300 border-r border-gray-700 font-sans tabular-nums">$ {wd.amount.toLocaleString('en-US')}</td>
                                            <td className="p-3 text-gray-400 border-r border-gray-700 max-w-xs">
                                                <div className="font-bold text-gray-300">Withdrawal USD Balance</div>
