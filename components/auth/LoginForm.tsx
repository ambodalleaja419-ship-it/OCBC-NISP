  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-300 mt-2 text-sm tracking-wider">INVESTMENT</p>
      </div>
      ...
      <div className="space-y-4">
        <Input
          ...
          className="bg-slate-700/50 border-gray-600 focus:border-red-500"
        />
        ...
        <div>
          ...
          <div className="flex justify-end mt-2">
            <Link to="/forgot-password" className="text-red-500 hover:text-red-400 text-sm font-medium">
              Forgot Password?
            </Link>
          </div>
        </div>
      ...
      <button
        type="submit"
        disabled={isLoading}
        className={`w-full py-3 px-4 bg-red-600 hover:bg-red-500 text-white font-semibold rounded-lg transition duration-200 shadow-lg shadow-red-600/20 ${
      ...
      <p className="text-center text-gray-400 text-sm">
        ...
        <Link to="/register" className="text-red-500 hover:text-red-400 font-semibold ml-1">
          Register Now
        </Link>
      </p>
    </form>
